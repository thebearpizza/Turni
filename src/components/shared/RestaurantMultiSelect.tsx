...
// Selettore multiplo dei ristoranti — condiviso fra Cassa e Turni, non
// scoped a un'area sola: prima ogni tab aveva il proprio controllo
// (pillole in alcune, questo menu a tendina in altre), stesso tipo di
// disallineamento visivo che questo componente esiste per eliminare.
// Usa Popover (non DropdownMenu): un menu a tendina è pensato per un
// elenco di azioni che chiudono al tap, mentre qui serve un pannello
// che resta aperto mentre si selezionano più voci — su mobile il
// DropdownMenu di Radix richiedeva più tap per chiudersi proprio per
// questo disallineamento (semantica "menu" invece di "pannello"), il
// Popover si chiude in modo affidabile con un solo tap fuori o sul
// pulsante "Chiudi".
